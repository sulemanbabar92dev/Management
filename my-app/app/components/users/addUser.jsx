...
const AddUser = ({ modalOpen, setModalOpen, setUser }) => {
        ...
        <div className="flex justify-center items-center flex-col bg-white  px-6 py-6 w-full">
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-x-[30px] gap-y-[30px]">
              <label className="text-gray-700 font-semibold text-[17px]">
                Name
                <input
              ...
              <label className="text-gray-700 font-semibold text-[17px]">
                LastName
                <input
                  className="border  text-[15px] py-3 font-light rounded-2xl pl-2 w-full"
                  type="text"
              ...
              <label className="text-gray-700 font-semibold text-[17px]">
                Email
                <input
                  className="border text-[15px] py-3 rounded-2xl pl-2 w-full font-light"
                  type="email"
              ...
              <label className="text-gray-700 font-semibold text-[17px]">
                Contact
                <input
                  className="border  text-[15px] py-3 font-light rounded-2xl w-full pl-2"
                  type="number"
                  placeholder="enter your name"
              ...
              <label className="text-gray-700 font-semibold text-[17px]">
                Password
                <input
                  className="border  text-[15px]  py-3 font-light pl-2 rounded-2xl w-full"
                  type="password"
              ...
              <label className="text-gray-700 font-semibold text-[17px] ">
                Confirm Password
                <input
                  className="border  rounded-2xl py-3 text-[15px] font-light w-full pl-2 overflow-auto"
                  type="password"
